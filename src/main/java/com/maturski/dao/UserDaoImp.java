...
import com.maturski.dbUtility.DBUtility;
import com.maturski.pojo.User;
...
public class UserDaoImp implements UserDao
{
	...
	public boolean addUser(User user)
	{
    	...
    	try
    	{
    	    ...
    	    stmt.setString(3,MD5.getMD5Hash(user.getUserPassword()));
	...
	public User login(String userEmail, String password)
	{
		   ...
		   try 
		   {
		    ...
		    while(rs.next())
			{
		    	user=new User(rs.getInt("userId"),rs.getString("userName"),rs.getString("userEmail"),rs.getString("userPhone"),rs.getString("userAddress"),rs.getString("userType"));
			}
		   }
		   catch (SQLException e) 
		   {
	...
	public List<User> getAllUser(String userType)
	{
		...
		try
    	{
    	    ...
    	    while(rs.next())
    	    {
    	        user=new User(rs.getInt("userId"),rs.getString("userName"),rs.getString("userEmail"), rs.getString("userPhone"), rs.getString("userAddress"),
