...
import com.maturski.dao.*;
import com.maturski.pojo.*;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("order"))
		{
		    ...
		    for(Cart c:cart)
		    {
				...
				session.setAttribute("message","<span>Selected Products ordered successfully. Your Total Bill is &#8364;"+totalBill+"</span>");
