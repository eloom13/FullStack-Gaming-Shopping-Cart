...
import com.maturski.dao.MD5;
import com.maturski.dao.UserDaoImp;
...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action==null)
		{
			...
			String userPassword=MD5.getMD5Hash(request.getParameter("password"));
		...
		String password=MD5.getMD5Hash(request.getParameter("pass"));
