    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
<textarea style="height:150px" class="form-control" name="productDescription" placeholder="Enter Product Description here" required>
<li>	</li>
<li>	</li>
<li>	</li>
</textarea>
               ...
               <div class="form-group">
                   <input type="number"
                    class="form-control" name="productPrice" placeholder="Enter Product Price here" required>
               </div>
					...
					<div class="table-responsive">
						<table class="table">
							  ...
							  <tbody>
							   ...
							   %>
							    <tr>
							      <th scope="row" class="mid-align" style="text-align:center;"><%=u.getUserId() %></th>
							      <td class="mid-align"style="text-align:center;"><%=u.getUserName() %></td>
							      <td class="mid-align"style="text-align:center;"><%=u.getUserEmail() %></td>
							      <td class="mid-align"style="text-align:center;"><%=u.getUserPhone() %></td>
							      <td class="mid-align"style="text-align:center;"><%=u.getUserAddress() %></td>
							    </tr>
							    <%
							      }
							    %>
...
<div class="modal fade" id="show-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <thead class="custom-bg text-white">
    <tr>
      <th scope="col" style="text-align:center;">Category Id</th>
  ...
  <tbody>
   ...
   %>
    <tr>
      <td class="mid-align"style="text-align:center;"><%=c.getCategoryId() %></td>
      <td class="mid-align"style="text-align:center;"><%=c.getCategoryTitle() %></td>
      <td class="mid-align"style="text-align:center;"><%=c.getCategoryDescription() %></td>
      <td class="mid-align"style="text-align:center;"><a href="ProductOperationServlet?categoryId=<%=c.getCategoryId()%>&action=deleteCategory"><input type="submit" class="btn btn-danger" value="Delete" style="background-color:orange; border:0; outline:none;"></a></td>
    </tr>
    <%
      }
    %>
        	...
        	<table class="table">
			  <thead class="custom-bg text-white">
			    <tr>
			      ...
			      <th scope="col"style="text-align:center;">Product Discount</th>
			  ...
			  <tbody>
			   ...
			   %>
			    <tr>
			      ...
			      <td class="mid-align" style="text-align:center;"><img style="max-width:70px" class="img-fluid" src="slike/<%=p.getProductPhoto() %>" alt="users_pic" ></td>
			      <td class="" style="text-align:center;"><%=p.getProductDescription()%></td>
			       <td class="mid-align"style="text-align:center;"><%=c.getCategoryNameById(p.getCategoryId()) %></td>
			      <td class="mid-align"style="text-align:center;"><%=p.getProductPrice() %></td>
			      <td class="mid-align"style="text-align:center;"><%=p.getProductDiscount() %></td>
			      <td class="mid-align"style="text-align:center;"><%=p.getProductQuantity() %></td>
			    </tr>
			    <%
			      }
			    %>
				  ...
				  <tbody>
				   ...
				   %>
				    <tr class="text-center">
				      ...
				      <td><img style="max-height:100px;max-width:70px;width:auto;" class="img-fluid mx-auto d-block" src="slike/<%=p1.getProductPhoto() %>" alt="users_pic" ></td>
				      ...
				      <form action="OrderServlet" method="post">
				          ...
				          <div class="form-group mx-sm-7 mb-2">
				            <input type="text" class="form-control" name="deliveryDate" placeholder="Delivery Date" size="20" required>
				          </div>
				          <button type="submit" class="btn  text-white mb-2" style="background-color:green; border:0; outline:none;">Set</button>
				     </form>
				     </td>
				    </tr>
				    <%
